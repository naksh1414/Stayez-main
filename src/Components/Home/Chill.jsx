...
const Chill = () => {
  ...
  return (
    <main className=" my-10 md:my-[100px] h-full">
      <button
        className="h-12 z-20 -rotate-90 absolute transform translate-x-24 -translate-y-20 rounded-tl-xl rounded-tr-xl bottom-10 right-0 text-white text-2xl flex items-center bg-[#03A9F4] px-2"
